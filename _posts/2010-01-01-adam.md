...
You can see experimental results with the new optimizer on [Github][repo].
...
The $\epsilon$ is just there to make sure the algorithm does something sensible when the gradient vanishes.
